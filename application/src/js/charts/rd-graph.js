...
rd-graph renders chartObjects (created by rd-chart-objects.js) as Highcharts

 It implements features that were required during the ethnicity facts & figures project
